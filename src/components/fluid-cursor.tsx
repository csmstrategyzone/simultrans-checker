...
const PRIMARY = 600; // sunset layer
const SECONDARY = 400; // cream layer, chases with more lag

/**
 * A pool of warm light sitting in the page background. The cursor disturbs it;
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          background:
            "radial-gradient(circle, rgba(249,115,22,0.35) 0%, rgba(249,115,22,0.15) 25%, transparent 60%)",
        }}
      ...
      {/* Secondary: cream, laggier — the two never quite align */}
      <motion.div
        ...
        style={{
          ...
          willChange: "transform",
          background:
            "radial-gradient(circle, rgba(255,255,255,0.5) 0%, rgba(254,249,240,0.2) 30%, transparent 65%)",
        }}
        className="absolute left-0 top-0 rounded-full"
