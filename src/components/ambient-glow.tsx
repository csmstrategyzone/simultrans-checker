...
/**
 * Two blue blobs orbiting on different phases, plus a corner wash. The whole
    ...
    >
      ...
      >
        <div
          ...
          style={{
            // #68AEE0 fading into #00529B — the v1 corner wash was two oranges.
            background:
              "radial-gradient(circle, rgba(104,174,224,0.10) 0%, rgba(0,82,155,0.04) 45%, transparent 70%)",
          }}
        />

        <motion.div
          className="absolute -top-32 right-[12%] h-[34rem] w-[34rem] rounded-full"
          // var(--sunset) no longer exists — the v2 rebrand removed it, so this
          // blob was rendering with no background at all.
          style={{ background: "#68AEE0", filter: "blur(100px)", opacity: base }}
          animate={
            reduced
              ? undefined
              : {
        ...
        <motion.div
          ...
          style={{
            // var(--ember) likewise no longer exists.
            background: "#00529B",
            filter: "blur(80px)",
            opacity: base - 0.02,
          }}
